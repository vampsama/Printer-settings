...
#define STRING_CONFIG_H_AUTHOR "(jp, CR-10 S4)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 97.89473684 } // Stock Creality
...
#define X_BED_SIZE 400 // Nozzle is at X4 when homed
#define Y_BED_SIZE 400 // Nozzle is at Y2 when homed
